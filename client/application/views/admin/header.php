            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url('admin/agen'); ?>"><i class="fa fa-dashboard fa-fw"></i> Agen</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url('admin/deposit'); ?>"><i class="fa fa-dashboard fa-fw"></i> Deposit</a>
                        </li>
